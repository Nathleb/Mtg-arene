  ...
  parseEdhrecRank: function (edhrecRank) {
    ...
    switch (true) {
      case /^lte/.test(edhrecRank):
        query = {
          edhrec_rank: {
            $lte: parseInt(edhrecRank.slice(3), 10)
          }
        };
        break;
      ...
      case /^lt/.test(edhrecRank):
        query = {
          edhrec_rank: {
            $lt: parseInt(edhrecRank.slice(2), 10)
          }
        };
        break;
      ...
      case /^gte/.test(edhrecRank):
        query = {
          edhrec_rank: {
            $gte: parseInt(edhrecRank.slice(3), 10)
          }
        };
        break;
      ...
      case /^gt/.test(edhrecRank):
        query = {
          edhrec_rank: {
            $gt: parseInt(edhrecRank.slice(2), 10)
          }
        };
        break;
